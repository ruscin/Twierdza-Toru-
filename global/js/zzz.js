...
(function ( o ) {
  ...
  function scaleImageUp (i) {
    ...
    i.parentNode.className= i.parentNode.className+' zoomedParent'; // Stacking context
    i.style.position = "relative";
    i.className = i.className.replace(" zzzZoomable", " zzzZoomed");
    showOverlay(scaleRatio);
  }
  ...
  function showOverlay (scaleRatio) {
    var i = document.getElementsByClassName("zzzZoomed")[0];
    var o = document.createElement("DIV");
		var c = document.createElement("DIV");

    addEvent(o, 'click', zoomedHandler);
    addEvent(c, 'click', zoomedHandler);
    ...
    i.parentNode.insertBefore(o, i);
		...
		c.style.opacity = 0;
    c.style.transition = "opacity 400ms ease-out";
    ...
    var t = setTimeout(function() {
      ...
      clearTimeout(t);
		...
		var t1 = setTimeout(function() {
			c.className = "close";
			c.style.top = (970 - (scaleRatio*i.height/2))+'px';
			c.style.right = (550 - (scaleRatio*i.width/2))+'px';
  ...
  function hideOverlay () {
    ...
    var t = setTimeout(function () {
      ...
      i.parentNode.style.zIndex = i.zzz.parentNode.style.zIndex;
			i.parentNode.className = i.parentNode.className.replace(" zoomedParent", "");
      clearTimeout(t);
    }, 300);
  }
